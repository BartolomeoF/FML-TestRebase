...
sp.write_data_flex([a_arr,E_arr, UE_prime_UE_arr, Omega_m_arr, Omega_r_arr, Omega_lambda_arr, Omega_phi_arr, phi_prime_arr, phi_primeprime_arr],filename_expansion)
