...
from HiCOLA.Utilities.Other.read_parameters import read_in_parameters
...
if os.path.exists(filename_expansion):
    print(f"Warning: expansion file with same name found in \"{abs_directory}\", file has been overwritten.")
if os.path.exists(filename_force):
    print(f"Warning: force file with same name found in \"{abs_directory}\", file has been overwritten.")
